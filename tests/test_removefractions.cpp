...
TEST_CASE("Remove fractions from time THH:MM.mmm", "[removefractions]") {
  Time time = parsetime("T12:23.555");
  Time time2 = removefractions(time);
  ...
  Time time3 = removefractions(time, true);
...
TEST_CASE("Remove fractions from time THH.hhh", "[removefractions]") {
